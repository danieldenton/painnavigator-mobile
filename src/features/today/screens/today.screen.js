...
export const TodayScreen = ({ navigation }) => {
    const { uid, setCompletedProgram, setEducationProgram, educationProgram, setLastDateOnApp, lastDateOnApp, tour } = useContext(AuthenticationContext);
