...
let optionsDay = { weekday: "short", year: '2-digit', month: 'numeric', day: 'numeric', hour12: false, timeZone: timeZone }
...
export function formatDateWithDay(date_time_value) {
    return date_time_value ? new Intl.DateTimeFormat('en-US', optionsDay).format(date_time_value) : null;
};
