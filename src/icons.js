...
export const WellnessCoachIcon = () => {
    return (
        <Svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Path d="M15 31.4889V21C15 18.7909 16.7909 17 19 17H37C39.2091 17 41 18.7909 41 21V31.4889C41 33.698 39.2091 35.4889 37 35.4889H27.3139C27.031 35.4889 26.7614 35.6087 26.5718 35.8187L20.958 42.0353C20.6512 42.3751 20.087 42.1581 20.087 41.7002V35.9889C20.087 35.7127 19.8631 35.4889 19.587 35.4889H19C16.7909 35.4889 15 33.698 15 31.4889Z" stroke="black" strokeWidth="2"/>
